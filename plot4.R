...
par(mfrow=c(2,2))
plot(x=a$DateTime,y=a$Global_active_power, type="l", ylab="Global Active Power(kilowatts)", xlab="")
plot(x=a$DateTime,y=a$Voltage, type="l", ylab="Voltage", xlab="datetime") 
plot(x=a$DateTime,y=a$Sub_metering_1, type="l", ylab="Energy sub metering", xlab="")
points(x=a$DateTime,y=a$Sub_metering_2, col="red", type="l")
points(x=a$DateTime,y=a$Sub_metering_3, col="blue", type="l")
legend("topright", pch=NA, col=c("black","blue", "red"), legend=c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), lty=c(1, 1, 1), bty="n", cex=0.8)
plot(x=a$DateTime,y=a$Global_reactive_power, type="l", ylab="Global_reactive_power", xlab="datetime") 
dev.off()
}